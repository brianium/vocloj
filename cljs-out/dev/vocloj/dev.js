...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$nav$app_nav,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul,(function (){var iter__4529__auto__ = (function vocloj$dev$nav_$_iter__21184(s__21185){
return (new cljs.core.LazySeq(null,(function (){
var s__21185__$1 = s__21185;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__21185__$1);
if(temp__5753__auto__){
var s__21185__$2 = temp__5753__auto__;
...
var map__21188 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__21186);
...
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21188__$1,cljs.core.cst$kw$text);
var screen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21188__$1,cljs.core.cst$kw$screen);
cljs.core.chunk_append(b__21187,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav-item",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(screen,screen_id))?"nav-item--active":null)], null),cljs.core.cst$kw$on_DASH_click,((function (i__21186,map__21188,map__21188__$1,text,screen,c__4527__auto__,size__4528__auto__,b__21187,s__21185__$2,temp__5753__auto__,items){
return (function (){
...
});})(i__21186,map__21188,map__21188__$1,text,screen,c__4527__auto__,size__4528__auto__,b__21187,s__21185__$2,temp__5753__auto__,items))
], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,screen], null)));

var G__21192 = (i__21186 + (1));
i__21186 = G__21192;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21187),vocloj$dev$nav_$_iter__21184(cljs.core.chunk_rest(s__21185__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21187),null);
}
} else {
var map__21190 = cljs.core.first(s__21185__$2);
...
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21190__$1,cljs.core.cst$kw$text);
var screen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21190__$1,cljs.core.cst$kw$screen);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$class,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["nav-item",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(screen,screen_id))?"nav-item--active":null)], null),cljs.core.cst$kw$on_DASH_click,((function (map__21190,map__21190__$1,text,screen,s__21185__$2,temp__5753__auto__,items){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(_STAR_state,cljs.core.assoc,cljs.core.cst$kw$nav_SLASH_screen,screen);
});})(map__21190,map__21190__$1,text,screen,s__21185__$2,temp__5753__auto__,items))
], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,screen], null)),vocloj$dev$nav_$_iter__21184(cljs.core.rest(s__21185__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$application,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [vocloj.dev.nav,screen,_STAR_state], null),(function (){var G__21193 = screen;
...
vocloj.dev.config = new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$vocloj$dev_SLASH_state,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$nav_SLASH_screen,cljs.core.cst$kw$synth_SLASH_rate,cljs.core.cst$kw$recog_SLASH_transcript,cljs.core.cst$kw$mic_SLASH_chunks,cljs.core.cst$kw$synth_SLASH_voice_DASH_id,cljs.core.cst$kw$mic_SLASH_recordings,cljs.core.cst$kw$synth_SLASH_volume,cljs.core.cst$kw$synth_SLASH_text,cljs.core.cst$kw$synth_SLASH_pitch],[cljs.core.cst$kw$synth,1.0,null,cljs.core.PersistentVector.EMPTY,"Alex",cljs.core.PersistentVector.EMPTY,1.0,"",1.0]),cljs.core.cst$kw$vocloj$dev_SLASH_synthesizer,cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$vocloj$dev_SLASH_recognizer,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$options,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$continuous_QMARK_,true], null)], null),cljs.core.cst$kw$vocloj$dev_SLASH_recog_DASH_handler,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_state)], null),cljs.core.cst$kw$vocloj$dev_SLASH_microphone,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_state)], null),cljs.core.cst$kw$vocloj$dev_SLASH_ui,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$recog_DASH_handler,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_recog_DASH_handler),cljs.core.cst$kw$state,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_state),cljs.core.cst$kw$synth,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_synthesizer),cljs.core.cst$kw$recognizer,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_recognizer),cljs.core.cst$kw$stream,integrant.core.ref(cljs.core.cst$kw$vocloj$dev_SLASH_microphone)], null)], null);
integrant.core.init_key.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$vocloj$dev_SLASH_microphone,(function (_,p__21195){
var map__21196 = p__21195;
var map__21196__$1 = (((((!((map__21196 == null))))?(((((map__21196.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21196.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21196):map__21196);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21196__$1,cljs.core.cst$kw$state);
...
integrant.core.init_key.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$vocloj$dev_SLASH_recog_DASH_handler,(function (_,p__21198){
...
integrant.core.init_key.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$vocloj$dev_SLASH_recognizer,(function (_,p__21201){
...
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21202__$1,cljs.core.cst$kw$options);
...
integrant.core.init_key.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$vocloj$dev_SLASH_ui,(function (_,p__21204){
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21205__$1,cljs.core.cst$kw$state);
var synth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21205__$1,cljs.core.cst$kw$synth);
var recognizer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21205__$1,cljs.core.cst$kw$recognizer);
var stream = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21205__$1,cljs.core.cst$kw$stream);
var recog_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21205__$1,cljs.core.cst$kw$recog_DASH_handler);
