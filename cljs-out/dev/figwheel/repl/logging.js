...
var c_23458 = (new goog.debug.Console());
var G__23457_23459 = c_23458.getFormatter();
goog.object.set(G__23457_23459,"showAbsoluteTime",false);

goog.object.set(G__23457_23459,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_23458);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__23460_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__23460_SHARP_);
