...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10626 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10626(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10627 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10627(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10628 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10628(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10629 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10629(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10630 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10630(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10631 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10631(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10632 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10632(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10633 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10633(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10634 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10634(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10635 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10635(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10636 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10636(b);
}
});
